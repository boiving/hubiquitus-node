...
exports.validateHMessage = function(hMessage, cb){
    var db = require('./dbPool.js').db.getDb(exports.getDomainJID(hMessage.actor));
 ...
 */
exports.cleanLocationAttrs = function(obj){
    for(var key in obj){
        if(key === 'pos')
    ...
    for(var i = 0; i < attrs.length; i++){
        ...
        if(obj[attrs[i]] instanceof Object){
            ...
            for(var attr in obj[attrs[i]]){
                if(attrs[i] === 'location'){
                    obj[attrs[i]] = exports.cleanLocationAttrs(obj[attrs[i]])
                }
